...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.provider_id'
        db.add_column(u'report', 'provider_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.provider_id'
        db.delete_column(u'report', 'provider_id')
    ...
    models = {
        ...
        u'core.queuemembers': {
            ...
            'uniqueid': ('django.db.models.fields.CharField', [], {'default': '1372026', 'max_length': '20', 'blank': 'True'})
        },
        u'core.queues': {
