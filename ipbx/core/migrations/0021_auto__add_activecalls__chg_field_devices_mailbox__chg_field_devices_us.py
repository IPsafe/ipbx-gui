...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActiveCalls'
        db.create_table(u'active_calls', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('calldate', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 15, 0, 0), null=True)),
            ('channel', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('origin', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('destination', self.gf('django.db.models.fields.CharField')(max_length=80, null=True)),
            ('forward', self.gf('django.db.models.fields.CharField')(max_length=32, null=True)),
            ('provider', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('call_type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('callerid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('uniqueid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
        ))
        db.send_create_signal(u'core', ['ActiveCalls'])


        # Changing field 'Devices.mailbox'
        db.alter_column(u'devices', 'mailbox', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True))

        # Changing field 'Devices.useragent'
        db.alter_column(u'devices', 'useragent', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting model 'ActiveCalls'
        db.delete_table(u'active_calls')


        # Changing field 'Devices.mailbox'
        db.alter_column(u'devices', 'mailbox', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        u'core.activecalls': {
            'Meta': {'object_name': 'ActiveCalls', 'db_table': "u'active_calls'"},
            'call_type': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'calldate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 15, 0, 0)', 'null': 'True'}),
            'callerid': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'channel': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            'destination': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True'}),
            'forward': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'origin': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            'provider': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'uniqueid': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'})
        },
        u'core.blacklist': {
        ...
        u'core.queuelog': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 15, 0, 0)', 'null': 'True'})
        },
        u'core.queuemembers': {
