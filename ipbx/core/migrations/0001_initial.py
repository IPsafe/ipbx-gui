...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'conference', (
            ...
            ('confno', self.gf('django.db.models.fields.CharField')(unique=True, max_length=80)),
            ...
            ('pin', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('opts', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('adminpin', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('adminopts', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('members', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('maxusers', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['Conference'])

        # Adding model 'Dayoff'
        db.create_table(u'dayoff', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal(u'core', ['Dayoff'])

        # Adding model 'DayoffArea'
        db.create_table(u'dayoff_area', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('area_type', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'core', ['DayoffArea'])

        # Adding model 'Devices'
        db.create_table(u'devices', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('lcr', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Lcr'], null=True, blank=True)),
            ('dialrules_groups', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.DialrulesGroups'], null=True, blank=True)),
            ('rate_groups', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.RatesGroups'], null=True, blank=True)),
            ...
            ('amaflags', self.gf('django.db.models.fields.CharField')(max_length=7, blank=True)),
            ('callgroup', self.gf('django.db.models.fields.CharField')(default=u'1', max_length=10, blank=True)),
            ('callerid', self.gf('django.db.models.fields.CharField')(max_length=80, blank=True)),
            ('canreinvite', self.gf('django.db.models.fields.CharField')(max_length=3, blank=True)),
            ('context', self.gf('django.db.models.fields.CharField')(default=u'default', max_length=80, blank=True)),
            ('defaultip', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True)),
            ('dtmfmode', self.gf('django.db.models.fields.CharField')(default=u'rfc2833', max_length=7, blank=True)),
            ...
            ('host', self.gf('django.db.models.fields.CharField')(default=u'dynamic', max_length=31, blank=True)),
            ('insecure', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('language', self.gf('django.db.models.fields.CharField')(default=u'br', max_length=2, blank=True)),
            ('mailbox', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('md5secret', self.gf('django.db.models.fields.CharField')(max_length=80, blank=True)),
            ('nat', self.gf('django.db.models.fields.CharField')(default=u'force_rport,comedia', max_length=20, blank=True)),
            ...
            ('mask', self.gf('django.db.models.fields.CharField')(max_length=95, blank=True)),
            ('pickupgroup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PickupGroups'], null=True, db_column=u'pickupgroup', blank=True)),
            ('port', self.gf('django.db.models.fields.CharField')(default=u'5060', max_length=5, blank=True)),
            ('qualify', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('restrictcid', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('rtptimeout', self.gf('django.db.models.fields.CharField')(max_length=3, blank=True)),
            ('rtpholdtimeout', self.gf('django.db.models.fields.CharField')(max_length=3, blank=True)),
            ('secret', self.gf('django.db.models.fields.CharField')(max_length=80, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(default=u'friend', max_length=30, blank=True)),
            ('allow', self.gf('django.db.models.fields.CharField')(default=u'alaw,ulaw,g729', max_length=200, blank=True)),
            ('musiconhold', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('regseconds', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('ipaddr', self.gf('django.db.models.fields.CharField')(max_length=45, blank=True)),
            ('regexten', self.gf('django.db.models.fields.CharField')(max_length=80, blank=True)),
            ('cancallforward', self.gf('django.db.models.fields.CharField')(max_length=3, blank=True)),
            ('lastms', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('defaultuser', self.gf('django.db.models.fields.CharField')(max_length=80, blank=True)),
            ('fullcontact', self.gf('django.db.models.fields.CharField')(max_length=80, blank=True)),
            ('regserver', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('useragent', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('callbackextension', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('dnd', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('followme', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('followme_busy', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('followme_noanswer', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('overflow', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('monitor', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('force_monitor', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('rtcachefriends', self.gf('django.db.models.fields.CharField')(default=u'yes', max_length=30, blank=True)),
            ('rtautoclear', self.gf('django.db.models.fields.CharField')(default=u'no', max_length=30, blank=True)),
        ))
        db.send_create_signal(u'core', ['Devices'])

        # Adding model 'Dialrules'
        db.create_table(u'dialrules', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dialrules_groups', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.DialrulesGroups'])),
        ...
        db.send_create_signal(u'core', ['Dialrules'])

        # Adding model 'DialrulesGroups'
        db.create_table(u'dialrules_groups', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'core', ['DialrulesGroups'])

        # Adding model 'ExtensionsConf'
        db.create_table(u'extensions_conf', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('context', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('exten', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('priority', self.gf('django.db.models.fields.IntegerField')()),
            ('app', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('appdata', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
        ))
        db.send_create_signal(u'core', ['ExtensionsConf'])

        # Adding model 'InboundRoutes'
        db.create_table(u'inbound_routes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('providers', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Providers'])),
            ('area_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('did', self.gf('django.db.models.fields.CharField')(unique=True, max_length=25)),
        ))
        db.send_create_signal(u'core', ['InboundRoutes'])

        # Adding model 'InboundRules'
        db.create_table(u'inbound_rules', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inbound_routes', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.InboundRoutes'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'core', ['InboundRules'])
        ...
        db.create_table(u'lcr_providers', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lcr', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Lcr'])),
            ('provider', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Providers'])),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('priority', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal(u'core', ['LcrProviders'])

        # Adding model 'Musiconhold'
        db.create_table(u'musiconhold', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=80)),
            ...
            ('mode', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('digit', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('sort', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('format', self.gf('django.db.models.fields.CharField')(max_length=16)),
        ))
        db.send_create_signal(u'core', ['Musiconhold'])

        # Adding model 'PickupGroups'
        db.create_table(u'pickup_groups', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ))
        db.send_create_signal(u'core', ['PickupGroups'])

        # Adding model 'QueueMembers'
        db.create_table(u'queue_members', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('queues', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Queues'], null=True, blank=True)),
            ('queue_name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('interface', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('penalty', self.gf('django.db.models.fields.IntegerField')()),
            ('paused', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('uniqueid', self.gf('django.db.models.fields.CharField')(default=9909286, max_length=20, blank=True)),
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Devices'], null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['QueueMembers'])

        # Adding model 'Queues'
        db.create_table(u'queues', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('musiconhold', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('announce', self.gf('django.db.models.fields.CharField')(default=u'0', max_length=128, null=True, blank=True)),
            ('context', self.gf('django.db.models.fields.CharField')(default=u'default', max_length=128, null=True, blank=True)),
            ('timeout', self.gf('django.db.models.fields.IntegerField')(default=u'20', null=True, blank=True)),
            ('monitor_join', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('monitor_format', self.gf('django.db.models.fields.CharField')(default=u'wav', max_length=128, null=True, blank=True)),
            ('queue_youarenext', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('queue_thereare', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('queue_callswaiting', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('queue_holdtime', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('queue_minutes', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('queue_seconds', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('queue_lessthan', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('queue_thankyou', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('queue_reporthold', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('announce_frequency', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('announce_round_seconds', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('announce_holdtime', self.gf('django.db.models.fields.CharField')(default=u'no', max_length=128, null=True, blank=True)),
            ('retry', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('wrapuptime', self.gf('django.db.models.fields.IntegerField')(default=5, null=True, blank=True)),
            ('maxlen', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('servicelevel', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('strategy', self.gf('django.db.models.fields.CharField')(default=u'linear', max_length=128, null=True, blank=True)),
            ('joinempty', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('leavewhenempty', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('eventmemberstatus', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('eventwhencalled', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True)),
            ('reportholdtime', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('memberdelay', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('timeoutrestart', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('setinterfacevar', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['Queues'])

        # Adding model 'Rates'
        db.create_table(u'rates', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rates_groups', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.RatesGroups'])),
        ...
        db.send_create_signal(u'core', ['Rates'])

        # Adding model 'RatesGroups'
        db.create_table(u'rates_groups', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=80)),
        ))
        db.send_create_signal(u'core', ['RatesGroups'])

        # Adding model 'Report'
        db.create_table(u'report', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_id', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('exten_description', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('origin', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('extension', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('agent', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('agent_type', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
            ('destination', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('forward', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=40, null=True)),
            ('duration', self.gf('django.db.models.fields.IntegerField')()),
            ('calldate', self.gf('django.db.models.fields.DateTimeField')()),
            ('provider', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
            ('value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=30, decimal_places=0, blank=True)),
            ('call_type', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('observation', self.gf('django.db.models.fields.CharField')(max_length=60, null=True)),
            ('uniqueid', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('duration_billing', self.gf('django.db.models.fields.IntegerField')()),
            ('uri', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['Report'])

        # Adding model 'VoicemailUsers'
        db.create_table(u'voicemail_users', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('customer_id', self.gf('django.db.models.fields.IntegerField')()),
            ('context', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('mailbox', self.gf('django.db.models.fields.IntegerField')()),
            ('password', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ...
            ('pager', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('stamp', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'core', ['VoicemailUsers'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Dayoff'
        db.delete_table(u'dayoff')

        # Deleting model 'DayoffArea'
        db.delete_table(u'dayoff_area')

        # Deleting model 'Devices'
        db.delete_table(u'devices')

        # Deleting model 'Dialrules'
        db.delete_table(u'dialrules')

        # Deleting model 'DialrulesGroups'
        db.delete_table(u'dialrules_groups')

        # Deleting model 'ExtensionsConf'
        db.delete_table(u'extensions_conf')

        # Deleting model 'InboundRoutes'
        db.delete_table(u'inbound_routes')

        # Deleting model 'InboundRules'
        db.delete_table(u'inbound_rules')

        # Deleting model 'Lcr'
        db.delete_table(u'lcr')

        # Deleting model 'LcrProviders'
        db.delete_table(u'lcr_providers')

        # Deleting model 'Musiconhold'
        db.delete_table(u'musiconhold')

        # Deleting model 'PickupGroups'
        db.delete_table(u'pickup_groups')

        # Deleting model 'QueueMembers'
        db.delete_table(u'queue_members')

        # Deleting model 'Queues'
        db.delete_table(u'queues')

        # Deleting model 'Rates'
        db.delete_table(u'rates')

        # Deleting model 'RatesGroups'
        db.delete_table(u'rates_groups')

        # Deleting model 'Report'
        db.delete_table(u'report')

        # Deleting model 'VoicemailUsers'
        db.delete_table(u'voicemail_users')
    ...
    models = {
        ...
        u'core.devices': {
            ...
            'context': ('django.db.models.fields.CharField', [], {'default': "u'default'", 'max_length': '80', 'blank': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '80'}),
            'nat': ('django.db.models.fields.CharField', [], {'default': "u'force_rport,comedia'", 'max_length': '20', 'blank': 'True'}),
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "u'friend'", 'max_length': '30', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
        ...
        u'core.musiconhold': {
            ...
            'digit': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'directory': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'format': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mode': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '80'}),
            'sort': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'core.pickupgroups': {
        ...
        u'core.providers': {
            ...
            'musiconhold': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '80'}),
            'nat': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
            'overflow': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'permit': ('django.db.models.fields.CharField', [], {'max_length': '95', 'blank': 'True'}),
            'pickupgroup': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.PickupGroups']", 'null': 'True', 'db_column': "u'pickupgroup'", 'blank': 'True'}),
            'port': ('django.db.models.fields.CharField', [], {'default': "u'5060'", 'max_length': '5', 'blank': 'True'}),
        ...
        u'core.queuemembers': {
            ...
            'device': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Devices']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'uniqueid': ('django.db.models.fields.CharField', [], {'default': '9909286', 'max_length': '20', 'blank': 'True'})
        },
        u'core.queues': {
        ...
        u'core.report': {
            ...
            'duration_billing': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'observation': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True'}),
            ...
            'uniqueid': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            ...
            'value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '30', 'decimal_places': '0', 'blank': 'True'})
        },
