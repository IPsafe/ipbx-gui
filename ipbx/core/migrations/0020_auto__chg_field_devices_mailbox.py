...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'core.devices': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'useragent': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'})
        },
        u'core.dialrules': {
        ...
        u'core.queuelog': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 14, 0, 0)', 'null': 'True'})
        },
        u'core.queuemembers': {
