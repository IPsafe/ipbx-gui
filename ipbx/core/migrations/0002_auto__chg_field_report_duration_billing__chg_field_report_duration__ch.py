...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.duration_billing'
        db.alter_column(u'report', 'duration_billing', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Report.duration'
        db.alter_column(u'report', 'duration', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Report.calldate'
        db.alter_column(u'report', 'calldate', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Report.duration_billing'
        db.alter_column(u'report', 'duration_billing', self.gf('django.db.models.fields.IntegerField')(default=''))

        # Changing field 'Report.duration'
        db.alter_column(u'report', 'duration', self.gf('django.db.models.fields.IntegerField')(default=''))

        # Changing field 'Report.calldate'
        db.alter_column(u'report', 'calldate', self.gf('django.db.models.fields.DateTimeField')(default=''))
    ...
    models = {
        ...
        u'core.queuemembers': {
            ...
            'uniqueid': ('django.db.models.fields.CharField', [], {'default': '9615623', 'max_length': '20', 'blank': 'True'})
        },
        u'core.queues': {
