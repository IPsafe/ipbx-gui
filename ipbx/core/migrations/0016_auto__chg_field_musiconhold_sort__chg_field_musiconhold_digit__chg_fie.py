...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Musiconhold.sort'
        db.alter_column(u'musiconhold', 'sort', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Musiconhold.digit'
        db.alter_column(u'musiconhold', 'digit', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'Musiconhold.format'
        db.alter_column(u'musiconhold', 'format', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Musiconhold.application'
        db.alter_column(u'musiconhold', 'application', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Musiconhold.mode'
        db.alter_column(u'musiconhold', 'mode', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'Musiconhold.directory'
        db.alter_column(u'musiconhold', 'directory', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Musiconhold.sort'
        db.alter_column(u'musiconhold', 'sort', self.gf('django.db.models.fields.CharField')(default='', max_length=16))

        # Changing field 'Musiconhold.digit'
        db.alter_column(u'musiconhold', 'digit', self.gf('django.db.models.fields.CharField')(default=0, max_length=1))

        # Changing field 'Musiconhold.format'
        db.alter_column(u'musiconhold', 'format', self.gf('django.db.models.fields.CharField')(default='', max_length=16))

        # Changing field 'Musiconhold.application'
        db.alter_column(u'musiconhold', 'application', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Musiconhold.mode'
        db.alter_column(u'musiconhold', 'mode', self.gf('django.db.models.fields.CharField')(default='', max_length=80))

        # Changing field 'Musiconhold.directory'
        db.alter_column(u'musiconhold', 'directory', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
