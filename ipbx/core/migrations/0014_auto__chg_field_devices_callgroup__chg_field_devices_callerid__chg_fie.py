...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Devices.callgroup'
        db.alter_column(u'devices', 'callgroup', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Devices.callerid'
        db.alter_column(u'devices', 'callerid', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'Devices.canreinvite'
        db.alter_column(u'devices', 'canreinvite', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

    def backwards(self, orm):

        # Changing field 'Devices.callgroup'
        db.alter_column(u'devices', 'callgroup', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Devices.callerid'
        db.alter_column(u'devices', 'callerid', self.gf('django.db.models.fields.CharField')(default='', max_length=80))

        # Changing field 'Devices.canreinvite'
        db.alter_column(u'devices', 'canreinvite', self.gf('django.db.models.fields.CharField')(default='', max_length=3))
