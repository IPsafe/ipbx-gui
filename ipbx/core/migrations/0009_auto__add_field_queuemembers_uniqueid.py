...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'queue_members', 'uniqueid',
                      self.gf('django.db.models.fields.CharField')(default=4881788, max_length=20, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'core.queuemembers': {
            ...
            'uniqueid': ('django.db.models.fields.CharField', [], {'default': '4881788', 'max_length': '20', 'blank': 'True'})
        },
        u'core.queues': {
