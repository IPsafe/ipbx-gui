...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QueueLog'
        db.create_table(u'queue_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 10, 0, 0))),
            ('callid', self.gf('django.db.models.fields.CharField')(default=u'', max_length=32)),
            ('queuename', self.gf('django.db.models.fields.CharField')(default=u'', max_length=32)),
            ('agent', self.gf('django.db.models.fields.CharField')(default=u'', max_length=32)),
            ('event', self.gf('django.db.models.fields.CharField')(default=u'', max_length=32)),
            ('data1', self.gf('django.db.models.fields.CharField')(default=u'', max_length=100)),
            ('data2', self.gf('django.db.models.fields.CharField')(default=u'', max_length=100)),
            ('data3', self.gf('django.db.models.fields.CharField')(default=u'', max_length=100)),
            ('data4', self.gf('django.db.models.fields.CharField')(default=u'', max_length=100)),
            ('data5', self.gf('django.db.models.fields.CharField')(default=u'', max_length=100)),
        ))
        db.send_create_signal(u'core', ['QueueLog'])


    def backwards(self, orm):
        # Deleting model 'QueueLog'
        db.delete_table(u'queue_log')
    ...
    models = {
        ...
        u'core.queuemembers': {
            ...
            'uniqueid': ('django.db.models.fields.CharField', [], {'default': '7965054', 'max_length': '20', 'blank': 'True'})
        },
        u'core.queues': {
