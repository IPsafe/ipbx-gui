...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Devices.fromuser'
        db.alter_column(u'devices', 'fromuser', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

    def backwards(self, orm):

        # Changing field 'Devices.fromuser'
        db.alter_column(u'devices', 'fromuser', self.gf('django.db.models.fields.CharField')(default='', max_length=80))
