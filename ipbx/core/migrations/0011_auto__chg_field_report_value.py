...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.value'
        db.alter_column(u'report', 'value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=30, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'Report.value'
        db.alter_column(u'report', 'value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=30, decimal_places=0))
