...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Devices.mailbox'
        db.alter_column(u'devices', 'mailbox', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
    ...
    models = {
        ...
        u'core.devices': {
            ...
            'mailbox': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
