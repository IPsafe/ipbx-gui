...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.linkedid'
        db.add_column(u'report', 'linkedid',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Report.sequence'
        db.add_column(u'report', 'sequence',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Report.uniqueid'
        db.alter_column(u'report', 'uniqueid', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):
        # Deleting field 'Report.linkedid'
        db.delete_column(u'report', 'linkedid')

        # Deleting field 'Report.sequence'
        db.delete_column(u'report', 'sequence')


        # Changing field 'Report.uniqueid'
        db.alter_column(u'report', 'uniqueid', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    ...
    models = {
        ...
        u'core.queuelog': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 12, 0, 0)'})
        },
        u'core.queuemembers': {
