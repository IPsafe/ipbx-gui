...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Devices.context'
        db.alter_column(u'devices', 'context', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'Devices.rtcachefriends'
        db.alter_column(u'devices', 'rtcachefriends', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Devices.fullcontact'
        db.alter_column(u'devices', 'fullcontact', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'Devices.amaflags'
        db.alter_column(u'devices', 'amaflags', self.gf('django.db.models.fields.CharField')(max_length=7, null=True))

        # Changing field 'Devices.followme_noanswer'
        db.alter_column(u'devices', 'followme_noanswer', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Devices.restrictcid'
        db.alter_column(u'devices', 'restrictcid', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Devices.port'
        db.alter_column(u'devices', 'port', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'Devices.musiconhold'
        db.alter_column(u'devices', 'musiconhold', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Devices.defaultuser'
        db.alter_column(u'devices', 'defaultuser', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'Devices.followme_busy'
        db.alter_column(u'devices', 'followme_busy', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Devices.ipaddr'
        db.alter_column(u'devices', 'ipaddr', self.gf('django.db.models.fields.CharField')(max_length=45, null=True))

        # Changing field 'Devices.fromdomain'
        db.alter_column(u'devices', 'fromdomain', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'Devices.md5secret'
        db.alter_column(u'devices', 'md5secret', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'Devices.secret'
        db.alter_column(u'devices', 'secret', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'Devices.regserver'
        db.alter_column(u'devices', 'regserver', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Devices.qualify'
        db.alter_column(u'devices', 'qualify', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Devices.type'
        db.alter_column(u'devices', 'type', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Devices.followme'
        db.alter_column(u'devices', 'followme', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Devices.rtautoclear'
        db.alter_column(u'devices', 'rtautoclear', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Devices.nat'
        db.alter_column(u'devices', 'nat', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Devices.callbackextension'
        db.alter_column(u'devices', 'callbackextension', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Devices.insecure'
        db.alter_column(u'devices', 'insecure', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Devices.rtpholdtimeout'
        db.alter_column(u'devices', 'rtpholdtimeout', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Devices.defaultip'
        db.alter_column(u'devices', 'defaultip', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'Devices.cancallforward'
        db.alter_column(u'devices', 'cancallforward', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Devices.overflow'
        db.alter_column(u'devices', 'overflow', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Devices.accountcode'
        db.alter_column(u'devices', 'accountcode', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Devices.deny'
        db.alter_column(u'devices', 'deny', self.gf('django.db.models.fields.CharField')(max_length=95, null=True))

        # Changing field 'Devices.dtmfmode'
        db.alter_column(u'devices', 'dtmfmode', self.gf('django.db.models.fields.CharField')(max_length=7, null=True))

        # Changing field 'Devices.language'
        db.alter_column(u'devices', 'language', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'Devices.mask'
        db.alter_column(u'devices', 'mask', self.gf('django.db.models.fields.CharField')(max_length=95, null=True))

        # Changing field 'Devices.rtptimeout'
        db.alter_column(u'devices', 'rtptimeout', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Devices.allow'
        db.alter_column(u'devices', 'allow', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Devices.permit'
        db.alter_column(u'devices', 'permit', self.gf('django.db.models.fields.CharField')(max_length=95, null=True))

        # Changing field 'Devices.useragent'
        db.alter_column(u'devices', 'useragent', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Devices.regexten'
        db.alter_column(u'devices', 'regexten', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

    def backwards(self, orm):

        # Changing field 'Devices.context'
        db.alter_column(u'devices', 'context', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'Devices.rtcachefriends'
        db.alter_column(u'devices', 'rtcachefriends', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Devices.fullcontact'
        db.alter_column(u'devices', 'fullcontact', self.gf('django.db.models.fields.CharField')(default='', max_length=80))

        # Changing field 'Devices.amaflags'
        db.alter_column(u'devices', 'amaflags', self.gf('django.db.models.fields.CharField')(default='', max_length=7))

        # Changing field 'Devices.followme_noanswer'
        db.alter_column(u'devices', 'followme_noanswer', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Devices.restrictcid'
        db.alter_column(u'devices', 'restrictcid', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Devices.port'
        db.alter_column(u'devices', 'port', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Devices.musiconhold'
        db.alter_column(u'devices', 'musiconhold', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Devices.defaultuser'
        db.alter_column(u'devices', 'defaultuser', self.gf('django.db.models.fields.CharField')(default='', max_length=80))

        # Changing field 'Devices.followme_busy'
        db.alter_column(u'devices', 'followme_busy', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Devices.ipaddr'
        db.alter_column(u'devices', 'ipaddr', self.gf('django.db.models.fields.CharField')(default='', max_length=45))

        # Changing field 'Devices.fromdomain'
        db.alter_column(u'devices', 'fromdomain', self.gf('django.db.models.fields.CharField')(default='', max_length=80))

        # Changing field 'Devices.md5secret'
        db.alter_column(u'devices', 'md5secret', self.gf('django.db.models.fields.CharField')(default='', max_length=80))

        # Changing field 'Devices.secret'
        db.alter_column(u'devices', 'secret', self.gf('django.db.models.fields.CharField')(default='', max_length=80))

        # Changing field 'Devices.regserver'
        db.alter_column(u'devices', 'regserver', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Devices.qualify'
        db.alter_column(u'devices', 'qualify', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'Devices.type'
        db.alter_column(u'devices', 'type', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Devices.followme'
        db.alter_column(u'devices', 'followme', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Devices.rtautoclear'
        db.alter_column(u'devices', 'rtautoclear', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Devices.nat'
        db.alter_column(u'devices', 'nat', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Devices.callbackextension'
        db.alter_column(u'devices', 'callbackextension', self.gf('django.db.models.fields.CharField')(default='', max_length=40))

        # Changing field 'Devices.insecure'
        db.alter_column(u'devices', 'insecure', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'Devices.rtpholdtimeout'
        db.alter_column(u'devices', 'rtpholdtimeout', self.gf('django.db.models.fields.CharField')(default='', max_length=3))

        # Changing field 'Devices.defaultip'
        db.alter_column(u'devices', 'defaultip', self.gf('django.db.models.fields.CharField')(default='', max_length=15))

        # Changing field 'Devices.cancallforward'
        db.alter_column(u'devices', 'cancallforward', self.gf('django.db.models.fields.CharField')(default='', max_length=3))

        # Changing field 'Devices.overflow'
        db.alter_column(u'devices', 'overflow', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Devices.accountcode'
        db.alter_column(u'devices', 'accountcode', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'Devices.deny'
        db.alter_column(u'devices', 'deny', self.gf('django.db.models.fields.CharField')(default='', max_length=95))

        # Changing field 'Devices.dtmfmode'
        db.alter_column(u'devices', 'dtmfmode', self.gf('django.db.models.fields.CharField')(max_length=7))

        # Changing field 'Devices.language'
        db.alter_column(u'devices', 'language', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'Devices.mask'
        db.alter_column(u'devices', 'mask', self.gf('django.db.models.fields.CharField')(default='', max_length=95))

        # Changing field 'Devices.rtptimeout'
        db.alter_column(u'devices', 'rtptimeout', self.gf('django.db.models.fields.CharField')(default='', max_length=3))

        # Changing field 'Devices.allow'
        db.alter_column(u'devices', 'allow', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Devices.permit'
        db.alter_column(u'devices', 'permit', self.gf('django.db.models.fields.CharField')(default='', max_length=95))

        # Changing field 'Devices.useragent'
        db.alter_column(u'devices', 'useragent', self.gf('django.db.models.fields.CharField')(default='', max_length=40))

        # Changing field 'Devices.regexten'
        db.alter_column(u'devices', 'regexten', self.gf('django.db.models.fields.CharField')(default='', max_length=80))
    ...
    models = {
        ...
        u'core.devices': {
            ...
            'followme': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True'}),
            ...
            'overflow': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True'}),
        ...
        u'core.queuelog': {
            ...
            'agent': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '32'}),
            'callid': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '32'}),
            'data1': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '100'}),
            'data2': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '100'}),
            'data3': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '100'}),
            'data4': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '100'}),
            'data5': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '100'}),
            'event': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'queuename': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '32'}),
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 7, 0, 0)'})
        },
        u'core.queuemembers': {
