...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'queue_members', 'paused', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

    def backwards(self, orm):

        # Changing field 'QueueMembers.paused'
        db.alter_column(u'queue_members', 'paused', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
    ...
    models = {
        ...
        u'core.queuemembers': {
            ...
            'paused': ('django.db.models.fields.CharField', [], {'default': "u'no'", 'max_length': '5', 'null': 'True', 'blank': 'True'}),
