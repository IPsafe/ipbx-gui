...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QueueMembers.uniqueid'
        db.delete_column(u'queue_members', 'uniqueid')

        # Deleting field 'QueueMembers.device'
        db.delete_column(u'queue_members', 'device_id')


        # Changing field 'QueueMembers.paused'
        db.alter_column(u'queue_members', 'paused', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):
        # Adding field 'QueueMembers.uniqueid'
        db.add_column(u'queue_members', 'uniqueid',
                      self.gf('django.db.models.fields.CharField')(default=7965054, max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'QueueMembers.device'
        db.add_column(u'queue_members', 'device',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Devices'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'QueueMembers.paused'
        db.alter_column(u'queue_members', 'paused', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'core.queuelog': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 10, 0, 0)'})
        },
        u'core.queuemembers': {
            ...
            'paused': ('django.db.models.fields.CharField', [], {'default': "u'no'", 'max_length': '1', 'blank': 'True'}),
