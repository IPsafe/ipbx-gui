...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QueueLog.event'
        db.alter_column(u'queue_log', 'event', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'QueueLog.callid'
        db.alter_column(u'queue_log', 'callid', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'QueueLog.agent'
        db.alter_column(u'queue_log', 'agent', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'QueueLog.queuename'
        db.alter_column(u'queue_log', 'queuename', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'QueueLog.time'
        db.alter_column(u'queue_log', 'time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'QueueLog.data5'
        db.alter_column(u'queue_log', 'data5', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'QueueLog.data4'
        db.alter_column(u'queue_log', 'data4', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'QueueLog.data1'
        db.alter_column(u'queue_log', 'data1', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'QueueLog.data3'
        db.alter_column(u'queue_log', 'data3', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'QueueLog.data2'
        db.alter_column(u'queue_log', 'data2', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'QueueLog.event'
        db.alter_column(u'queue_log', 'event', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'QueueLog.callid'
        db.alter_column(u'queue_log', 'callid', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'QueueLog.agent'
        db.alter_column(u'queue_log', 'agent', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'QueueLog.queuename'
        db.alter_column(u'queue_log', 'queuename', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'QueueLog.time'
        db.alter_column(u'queue_log', 'time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'QueueLog.data5'
        db.alter_column(u'queue_log', 'data5', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'QueueLog.data4'
        db.alter_column(u'queue_log', 'data4', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'QueueLog.data1'
        db.alter_column(u'queue_log', 'data1', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'QueueLog.data3'
        db.alter_column(u'queue_log', 'data3', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'QueueLog.data2'
        db.alter_column(u'queue_log', 'data2', self.gf('django.db.models.fields.CharField')(max_length=100))
